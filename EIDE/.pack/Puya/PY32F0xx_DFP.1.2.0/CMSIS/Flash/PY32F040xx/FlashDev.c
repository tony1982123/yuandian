...
struct FlashDevice const FlashDevice  =
{
    ...
    "PY32F040xx 32kB Flash",   // Device Name (32kB)
    ONCHIP,                     // Device Type
...
{
    FLASH_DRV_VERS,             // Driver Version, do not modify!
    "PY32F040xx 64kB Flash",   // Device Name (64kB)
    ONCHIP,                     // Device Type
    0x08000000,                 // Device Start Address
...
{
    FLASH_DRV_VERS,             // Driver Version, do not modify!
    "PY32F040xx 96kB Flash",   // Device Name (96kB)
    ONCHIP,                     // Device Type
    0x08000000,                 // Device Start Address
...
{
    FLASH_DRV_VERS,             // Driver Version, do not modify!
    "PY32F040xx 128kB Flash",   // Device Name (128kB)
    ONCHIP,                     // Device Type
    0x08000000,                 // Device Start Address
...
{
  FLASH_DRV_VERS,                     // Driver Version, do not modify!
  "PY32F040xx Flash Options",         // Device Name
  ONCHIP,                             // Device Type
